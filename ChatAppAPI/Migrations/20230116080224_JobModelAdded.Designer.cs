...
namespace ChatAppAPI.Migrations
{
    ...
    [Migration("20230116080224_JobModelAdded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GhostLibrary.Models.BewerbungModel", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GhostLibrary.Models.JobModel", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GhostLibrary.Models.BewerbungModel", b =>
                {
                    b.HasOne("GhostLibrary.Models.JobModel", "Job")
                        .WithMany()
                        .HasForeignKey("JobID")
